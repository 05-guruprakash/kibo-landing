...
const GhibliBackground = () => {
  ...
  // Sky shifts from deep teal-blue → dusky indigo as you scroll
  const skyTop = lerpColor('#2a7fa8', '#1a2a5e', Math.min(scrollProgress * 1.5, 1));
  const skyBottom = lerpColor('#4dbdcf', '#3a4a8a', Math.min(scrollProgress * 1.5, 1));
  ...
  return (
    <div className="fixed inset-0 overflow-hidden z-0">
      ...
      <div
        ...
        style={{
          background: `linear-gradient(to bottom, ${skyTop} 0%, ${skyBottom} 55%, #5aab6e 55%, #5aab6e 100%)`,
        }}
      />

      {/* Far clouds - large painterly cumulus */}
      <motion.div
        className="absolute w-full"
        style={{ top: `${skyY * 0.4}px`, y: cloudY }}
      >
        <svg viewBox="0 0 1440 380" preserveAspectRatio="xMidYMid slice" className="w-full" style={{ height: '70vh' }}>
          {/* Large main cloud mass center-left */}
          ...
          <path
            d="M0 320 Q180 220 360 260 T720 230 T1080 255 T1440 240 L1440 380 L0 380 Z"
            fill="#5aab6e"
          />
          {/* Mid green hill mass */}
          <path
            d="M0 340 Q200 270 420 295 T840 278 T1200 292 T1440 285 L1440 380 L0 380 Z"
            fill="#4fa462"
          />
          {/* Foreground dark rich green */}
          <path
            d="M0 360 Q120 335 300 345 T600 338 T900 342 T1200 340 T1440 345 L1440 380 L0 380 Z"
            fill="#3d9050"
          />
        </svg>
      </motion.div>
      ...
      >
        <svg viewBox="0 0 1440 320" preserveAspectRatio="xMidYMax slice" className="w-full h-[55vh]">
          {/* Main rolling hill slope from bottom-right */}
          <path
            d="M0 320 L0 200 Q200 120 500 160 Q700 185 1000 100 Q1200 50 1440 80 L1440 320 Z"
            fill="#52b868"
          />
          {/* Hill texture - lighter patches */}
          <path
            d="M0 320 L0 220 Q150 160 400 190 Q600 210 900 140 Q1100 90 1440 110 L1440 320 Z"
            fill="#5ec97a"
            opacity="0.4"
          />
          {/* Darker shadow bottom */}
          <path
            d="M0 320 L0 280 Q300 260 600 268 T1200 272 T1440 268 L1440 320 Z"
            fill="#3a8a4e"
          />
        </svg>
      </motion.div>
      ...
      >
        <svg viewBox="0 0 1440 240" preserveAspectRatio="xMidYMax slice" className="w-full h-[40vh]">
          ...
          {/* Tall grass blades - foreground left */}
          <g>
            {/* Pink pampas grass stems */}
          ...
          {/* Small wildflowers in foreground */}
      ...
      {/* Night stars - appear from section 5 onward */}
      {currentSection >= 5 && (
        <motion.div
